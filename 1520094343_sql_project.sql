...
select surname, firstname, max(datediff(joindate,'1990-01-01'))
from Members
...
the member name. */
select distinct b.facid, f.name, concat(m.firstname, ' ', m.surname) as name
from Bookings as b
join Members as m
on b.memid = m.memid
...
Having CAST( b.starttime AS DATE ) =  '2012-09-14'
AND cost <30
